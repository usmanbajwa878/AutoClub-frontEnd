...
const AccountCreation = React.lazy(() =>
  import("./views/account/accountCreation/AccountCreation")
);
const AccountList = React.lazy(() =>
  import("./views/account/accountList/AccountList")
);
...
const routes = [
  ...
  { path: "/accounts/list", name: "AccountList", element: AccountList },
  {
